...
abstract class ShopDatabase: RoomDatabase() {
    ...
    companion object{
        private val products :List<Product> = listOf(
            Product(0, "Butter", 5.99, "Butter made from cow's milk", "dairy", null, "butter.jpg"),
            ...
            Product(0, "Rye Bread", 4.49, "Whole grain rye bread", "bakery", null, "rye_bread.jpg"),
            Product(0, "Mead", 19.99, "Natural mead with a smoky flavor", "beverages", 800, "mead.jpg"),
            Product(0, "Blue Cheese", 29.99, "Assorted blue cheeses", "dairy", null, "blue_cheese.jpg"),
            Product(0, "Buckwheat Groats", 2.49, "Unroasted buckwheat groats", "cereals", 50, "buckwheat_groats.jpg"),
            Product(0, "Ruskie Pierogi", 9.99, "Pierogi with potato and cheese filling", "ready meals", null, "pierogi.jpg"),
            Product(0, "Toruń Gingerbread", 12.99, "Traditional gingerbread from Toruń", "sweets", 200, "gingerbread.jpg"),
            Product(0, "Apple Juice", 4.99, "100% apple juice", "beverages", null, "apple_juice.jpg"),
            Product(0, "Goat Cheese", 14.99, "Goat cheese made from goat's milk", "dairy", 300, "goat_cheese.jpg"),
            Product(0, "Homemade Sausage", 18.99, "Sausage made from pork and beef", "meat", null, "homemade_sausage.jpg"),
            ...
            Product(0, "Feta Cheese", 9.99, "Feta cheese made from cow's milk", "dairy", null, "feta_cheese.jpg"),
            Product(0, "Wheat Beer", 4.99, "Craft wheat beer", "beverages", 100, "wheat_beer.jpg"),
            Product(0, "Blood Sausage", 8.99, "Blood sausage made from pork blood and fat", "meat", null, "blood_sausage.jpg"))
